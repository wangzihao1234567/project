...
data = pd.read_excel(r"D:\服务创业\新代码\sofm_1.xlsx")
X = data.iloc[:,:-1]
Y = data.iloc[:,-1]

data_test = pd.read_excel(r"D:\服务创业\新代码\sofm_test1.xlsx")
...
# 定义优化问题的约束条件
lb = np.array([108,8,1,2])  # 变量下界
ub = np.array([400,400,100,100])  # 变量上界
